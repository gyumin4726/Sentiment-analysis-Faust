...
plot_emotion_distribution(results_faust, "Faust 감정 분포 (LSTM)", "faust_LSTM.png")
plot_emotion_distribution(results_mephi, "Mephistopheles 감정 분포 (LSTM)", "mephi_LSTM.png")
